...
const appleSvg = (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      {'{'}' '{'}'}
      <title>apple [#173]</title> <desc>Created with Sketch.</desc> <defs> </defs>
      {'{'}' '{'}'}
...
export type AuthProviderVariant = {
  label: string;
  Svg: JSX.Element;
};

export const AUTH_PROVIDER_VARIANTS: Record<ProviderType, AuthProviderVariant> = {
  'google.com': {
    label: 'Google',
    Svg: googleSvg,
  },
