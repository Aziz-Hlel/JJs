...
import type { KaraokeSongTableRowResponse } from '@contracts/schemas/karaekoSong/KaraokeSongTableRowResponse';
...
const KaraokeSongService = {
  ...
  getPage: async (queryParams: { [k: string]: string | number | Array<string> }) =>
    await apiService.getThrowable<Page<KaraokeSongTableRowResponse>>(apiRoutes.karaokeSongs.getPage(), { params: queryParams }),
