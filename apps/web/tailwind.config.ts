...
const config: Config = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        slider:
          "linear-gradient(to bottom, rgba(5, 6, 8, 0.6), rgba(5, 6, 8, 1))",
      ...
      fontFamily: {
        "josefin-sans": ["Inter", "sans-serif"],
        mulish: ["Inter", "sans-serif"],
        "sorts-mill-goudy": ["Inter", "serif"],
        "barlow-condensed": ["Inter", "sans-serif"],
        "icon-awesome": ["Inter", "sans-serif"],
      },
      fontSize: {
        "display-1": [
          "108px",
        ...
        "subtitle-1": ["20px", { lineHeight: "1.4", letterSpacing: "1.5px" }],
        "subtitle-2": ["18px", { lineHeight: "1.4", letterSpacing: "1px" }],
        ...
        caption: ["15px", { lineHeight: "1.6", letterSpacing: "0.5px" }],
        overline: ["13px", { lineHeight: "1.6", letterSpacing: "1.5px" }],
      },
      container: {
        center: true,
        padding: "1rem",
